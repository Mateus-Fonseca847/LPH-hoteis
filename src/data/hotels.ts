...
export const hotels: Hotel[] = [
  {
    ...
    policies: [
      { title: "Cancelamento", description: "Cancelamento gratuito com até 5 dias de antecedência." },
      { title: "Crianças", description: "Crianças de até 6 anos têm cortesia na mesma acomodação dos responsáveis." },
  ...
  },
  {
    ...
    amenities: ["Lareira no lobby", "Spa", "Restaurante", "Piscina aquecida", "Adega", "Transfer sob demanda"],
    contacts: {
      phone: "(24) 2247-3300",
    ...
    policies: [
      ...
      { title: "Eventos", description: "Pequenos eventos privativos disponíveis mediante reserva." },
    ],
    checkIn: "15:00",
    checkOut: "12:00",
  },
  {
    slug: "jardins-select",
    name: "Jardins Select",
    shortDescription: "Endereço contemporâneo no coração de São Paulo para viagens urbanas com estilo.",
    fullDescription:
    ...
    policies: [
      ...
      { title: "Estacionamento", description: "Serviço de valet disponível mediante cobrança adicional." },
  ...
  },
  {
    slug: "lago-sul-prime",
    name: "Lago Sul Prime",
    shortDescription: "Hotel de atmosfera serena em Brasília, com conforto executivo e lazer discreto.",
    fullDescription:
    ...
    amenities: ["Piscina com deck", "Sala de reuniões", "Café da manhã", "Transfer executivo", "Concierge", "Lavanderia"],
    contacts: {
      phone: "(61) 3344-2211",
  ...
  },
  {
    ...
    shortDescription: "Hospedagem à beira-mar em Recife, com proposta leve e localização estratégica.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription: "Hotel com personalidade histórica em Salvador, perto da cultura e da gastronomia.",
    fullDescription:
    ...
    amenities: ["Terraço panorâmico", "Café regional", "Concierge cultural", "Transfers", "Wi-Fi", "Bar autoral"],
    contacts: {
      phone: "(71) 3012-9088",
    ...
    policies: [
      ...
      { title: "Crianças", description: "Hospedagem para crianças mediante consulta de categoria." },
    ],
    checkIn: "15:00",
    checkOut: "12:00",
  },
  {
    ...
    amenities: ["Lareira", "Spa", "Café colonial", "Bicicletas", "Transfer local", "Sala de leitura"],
    contacts: {
      phone: "(54) 3295-4433",
    ...
    policies: [
      ...
      { title: "Natal e inverno", description: "Datas sazonais têm condições específicas informadas na reserva." },
  ...
  },
  {
    ...
    shortDescription: "Hotel de frente para o mar em Florianópolis, com proposta leve e sofisticada.",
    fullDescription:
    ...
    policies: [
      ...
      { title: "Garagem", description: "Vagas limitadas conforme disponibilidade no dia da chegada." },
      { title: "Lazer", description: "Piscina e rooftop sujeitos a fechamento em caso de manutenção preventiva." },
    ],
    checkIn: "14:00",
    checkOut: "12:00",
  },
