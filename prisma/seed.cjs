...
const hotels = [
  {
    ...
    shortDescription:
      "Hospedagem leve perto do mar, ideal para dias tranquilos no litoral catarinense.",
    fullDescription:
    ...
    policies: [
      {
        title: "Cancelamento",
        description: "Cancelamento gratuito com ate 5 dias de antecedencia da chegada.",
      },
      {
        title: "Criancas",
        description: "Uma crianca de ate 6 anos pode se hospedar sem custo na mesma acomodacao.",
      },
      {
        title: "Pets",
        description: "Aceitamos pets de pequeno porte mediante solicitacao previa.",
      },
    ],
    rooms: buildRooms(
      "Charle Brown",
      ...
      [
        ...
        },
        {
          name: "Familia Jardim",
          description:
            "Acomodacao com espaco extra para viagens em familia e estadias mais longas.",
          capacity: 4,
  ...
  },
  {
    ...
    galleryImages: [
      ...
      },
      {
        ...
        alt: "Quarto aconchegante com iluminacao quente",
      },
      {
    ...
    policies: [
      {
        title: "Cancelamento",
        description: "Cancelamento gratuito com ate 7 dias de antecedencia.",
      },
      {
        title: "Nao fumantes",
        description: "Todas as suites e areas internas sao destinadas a nao fumantes.",
      },
      {
        title: "Estacionamento",
        description: "Vagas disponiveis mediante confirmacao no check-in.",
      },
    ],
    rooms: buildRooms(
      "Serra Imperial",
      ...
      [
        ...
        },
        {
          ...
          description:
            "Quarto amplo com area de estar e proposta mais reservada para fins de semana tranquilos.",
          capacity: 3,
  ...
  },
  {
    ...
    name: "LPH Jardins",
    shortDescription:
      "Hotel urbano com perfil contemporaneo em uma das regioes mais praticas da capital paulista.",
    fullDescription:
    ...
    galleryImages: [
      {
        ...
        alt: "Suite contemporanea com linhas minimalistas",
      },
      {
        url: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1400&q=80",
        alt: "Ambiente interno moderno com iluminacao suave",
      },
      {
        url: "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?auto=format&fit=crop&w=1400&q=80",
        alt: "Recepcao refinada de hotel urbano",
      },
    ],
    ...
    policies: [
      {
        title: "Cancelamento",
        description: "Cancelamento gratuito ate 48 horas antes do check-in.",
      },
      { title: "Valet", description: "Servico de valet disponivel mediante cobranca adicional." },
      {
        title: "Animais",
        description: "Permitimos pets de pequeno porte em acomodacoes selecionadas.",
      },
    ],
    rooms: buildRooms(
      "Jardins",
      ...
      [
        {
          ...
          description:
            "Configuracao pratica para viagens de negocios com boa bancada e conforto visual.",
          capacity: 2,
          beds: "1 cama queen",
          size: "24 m2",
          priceFrom: "740.00",
        ...
        },
        {
          name: "Corner Select",
          description:
            "Categoria superior com area adicional e atmosfera silenciosa em meio a rotina paulistana.",
          capacity: 2,
          beds: "1 cama king",
          size: "34 m2",
          priceFrom: "960.00",
  ...
  },
  {
    ...
    name: "LPH Lago Sul",
    shortDescription:
      "Hospedagem discreta e elegante em Brasilia, com foco em conforto e praticidade.",
    fullDescription:
    ...
    galleryImages: [
      {
        url: "https://images.unsplash.com/photo-1445019980597-93fa8acb246c?auto=format&fit=crop&w=1400&q=80",
        alt: "Area social de hotel com poltronas e iluminacao suave",
      },
      {
        url: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1400&q=80",
    ...
    policies: [
      {
        title: "Cancelamento",
        description: "Reembolso integral em cancelamentos com ate 72 horas de antecedencia.",
      },
      {
        title: "Early check-in",
        description: "Disponivel conforme ocupacao do dia e confirmacao previa.",
      },
      {
        title: "Servicos extras",
        description: "Consumos e servicos adicionais sao fechados no check-out.",
      },
    ],
    rooms: buildRooms(
      "Lago Sul",
      ...
      [
        {
          name: "Business Prime",
          description:
            "Quarto versatil para estadias executivas com apoio funcional e atmosfera discreta.",
          capacity: 2,
          beds: "1 cama queen",
          size: "27 m2",
          priceFrom: "680.00",
        ...
        },
        {
          name: "Vista Lago",
          description:
            "Categoria com espaco adicional e proposta mais confortavel para estadias prolongadas.",
          capacity: 3,
  ...
  },
  {
    ...
    galleryImages: [
      {
        url: "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?auto=format&fit=crop&w=1400&q=80",
        alt: "Lobby de hotel com recepcao e iluminacao moderna",
      },
      {
        url: "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1400&q=80",
        alt: "Piscina com area de descanso e coqueiros",
      },
      {
    ...
    policies: [
      {
        title: "Cancelamento",
        description: "Cancelamento gratuito ate 5 dias antes da data de entrada.",
      },
      {
        title: "Cafe da manha",
        description: "Incluso em todas as tarifas publicas disponiveis no site.",
      },
  ...
  },
  {
    ...
    name: "LPH Pelourinho",
    shortDescription:
      "Hospedagem com identidade cultural e clima acolhedor no centro historico de Salvador.",
    fullDescription:
    ...
    galleryImages: [
      {
        url: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1400&q=80",
        alt: "Quarto com varanda e decoracao acolhedora",
      },
      {
        url: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1400&q=80",
        alt: "Rua historica com atmosfera artistica",
      },
      {
    ...
    policies: [
      ...
      {
        title: "Hospedagem infantil",
        description: "Acomodacao de criancas sujeita a categoria reservada.",
      },
    ],
    rooms: buildRooms(
      "Pelourinho",
      ...
      [
        {
          name: "Historica",
          description:
            "Quarto com identidade cultural e ambientacao acolhedora no centro historico.",
          capacity: 2,
          beds: "1 cama queen",
          size: "25 m2",
          priceFrom: "560.00",
        ...
        },
        {
          ...
          description:
            "Categoria com varanda e clima intimista para explorar Salvador com conforto.",
          capacity: 3,
  ...
  },
  {
    ...
    shortDescription:
      "Hotel serrano com clima intimista e proposta voltada para descanso e conforto.",
    fullDescription:
    ...
    galleryImages: [
      {
        url: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1400&q=80",
        alt: "Suite acolhedora com cabeceira em madeira",
      },
      {
        url: "https://images.unsplash.com/photo-1578683010236-d716f9a3f461?auto=format&fit=crop&w=1400&q=80",
      ...
      {
        url: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1400&q=80",
        alt: "Ambiente interno moderno e confortavel",
      },
    ],
    amenities: [
      "Lareira",
    ...
    policies: [
      {
        title: "Cancelamento",
        description: "Cancelamento gratuito ate 10 dias antes da hospedagem.",
      },
      {
        title: "Alta temporada",
        description: "Periodos sazonais podem ter condicoes especiais de alteracao.",
      },
  ...
  },
  {
    ...
    name: "LPH Beira-Mar",
    shortDescription:
      "Hospedagem de frente para a orla com visual leve e confortavel em Florianopolis.",
    fullDescription:
    ...
    galleryImages: [
      {
        url: "https://images.unsplash.com/photo-1455587734955-081b22074882?auto=format&fit=crop&w=1400&q=80",
        alt: "Area externa de hotel com vista para o mar",
      },
      {
        url: "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1400&q=80",
        alt: "Piscina com borda e vegetacao ao redor",
      },
      {
        url: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1400&q=80",
        alt: "Suite com luz natural e varanda",
      },
    ],
    ...
    policies: [
      {
        title: "Cancelamento",
        description: "Cancelamento gratuito ate 72 horas antes do check-in.",
      },
      { title: "Garagem", description: "Vagas sujeitas a disponibilidade no dia da chegada." },
      {
        title: "Manutencao",
        description: "Areas de lazer podem fechar temporariamente para manutencao preventiva.",
      },
    ],
    rooms: buildRooms(
      "Beira-Mar",
      ...
      [
        {
          name: "Vista Mar",
          description:
            "Categoria com vista privilegiada e proposta leve para estadias a beira-mar.",
          capacity: 2,
          beds: "1 cama king",
          size: "31 m2",
          priceFrom: "650.00",
        ...
        },
        {
          ...
          description:
            "Acomodacao mais ampla para quem busca espaco adicional e conforto prolongado.",
          capacity: 3,
          beds: "1 cama king + sofa-cama",
          size: "44 m2",
          priceFrom: "910.00",
